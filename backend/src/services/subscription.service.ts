...
export async function subscribeChannel(subscriberId: string, channelId: string) {
...
export async function unsubscribeChannel(subscriberId: string, channelId: string) {
